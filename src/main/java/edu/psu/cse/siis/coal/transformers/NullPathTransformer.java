...
public class NullPathTransformer extends PathTransformer {
  private static final edu.psu.cse.siis.coal.transformers.NullPathTransformer instance = new edu.psu.cse.siis.coal.transformers.NullPathTransformer();
   ...
   */
  public static edu.psu.cse.siis.coal.transformers.NullPathTransformer v() {
    return instance;
  }
