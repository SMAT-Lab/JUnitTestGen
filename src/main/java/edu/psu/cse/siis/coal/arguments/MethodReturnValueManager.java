...
public class MethodReturnValueManager {
  ...
  private static final edu.psu.cse.siis.coal.arguments.MethodReturnValueManager instance = new edu.psu.cse.siis.coal.arguments.MethodReturnValueManager();

  private MethodReturnValueManager() {
  }

  public static edu.psu.cse.siis.coal.arguments.MethodReturnValueManager v() {
    return instance;
  }
