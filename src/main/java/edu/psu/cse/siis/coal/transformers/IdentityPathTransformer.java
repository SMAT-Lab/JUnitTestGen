...
public class IdentityPathTransformer extends PathTransformer {
  private static final edu.psu.cse.siis.coal.transformers.IdentityPathTransformer instance = new edu.psu.cse.siis.coal.transformers.IdentityPathTransformer();
   ...
   */
  public static edu.psu.cse.siis.coal.transformers.IdentityPathTransformer v() {
    return instance;
  }
