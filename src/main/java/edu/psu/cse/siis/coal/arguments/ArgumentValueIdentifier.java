...
public class ArgumentValueIdentifier {
  ...
  public boolean equals(Object other) {
    if (other instanceof edu.psu.cse.siis.coal.arguments.ArgumentValueIdentifier) {
      edu.psu.cse.siis.coal.arguments.ArgumentValueIdentifier argumentValueIdentifier = (edu.psu.cse.siis.coal.arguments.ArgumentValueIdentifier) other;
