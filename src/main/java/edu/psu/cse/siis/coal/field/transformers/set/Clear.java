...
public class Clear extends SetFieldTransformer {
  private static final edu.psu.cse.siis.coal.field.transformers.set.Clear instance = new edu.psu.cse.siis.coal.field.transformers.set.Clear();

  public static edu.psu.cse.siis.coal.field.transformers.set.Clear v() {
    return instance;
  }

  @Override
  public FieldTransformer compose(FieldTransformer secondFieldOperation) {
    if (secondFieldOperation instanceof edu.psu.cse.siis.coal.field.transformers.set.Clear) {
      return this;
    } else {
