...
public class TopFieldTransformer extends FieldTransformer {
  private static final edu.psu.cse.siis.coal.field.transformers.TopFieldTransformer instance = new edu.psu.cse.siis.coal.field.transformers.TopFieldTransformer();
   ...
   */
  public static edu.psu.cse.siis.coal.field.transformers.TopFieldTransformer v() {
    return instance;
  }
