...
public class PathValue {
  ...
  /**
   * Returns the {@link edu.psu.cse.siis.coal.values.PathValue} elements for this object without {@link IntermediateFieldValue} .
   *
  ...
  public Set<PathValue> makeFinalBranchValues(PropagationSolver solver) {
    ...
    for (Map<String, FieldValue> newFieldMap : fieldMaps) {
      edu.psu.cse.siis.coal.values.PathValue newBranchValue = new edu.psu.cse.siis.coal.values.PathValue();
  ...
  public boolean equals(Object other) {
    return other instanceof edu.psu.cse.siis.coal.values.PathValue
        && Objects.equals(this.fieldMap, ((edu.psu.cse.siis.coal.values.PathValue) other).fieldMap);
  }
}
