...
public class NullPathValue extends PathValue {
  private static final edu.psu.cse.siis.coal.values.NullPathValue instance = new edu.psu.cse.siis.coal.values.NullPathValue();
   ...
   */
  public static edu.psu.cse.siis.coal.values.NullPathValue v() {
    return instance;
  }
