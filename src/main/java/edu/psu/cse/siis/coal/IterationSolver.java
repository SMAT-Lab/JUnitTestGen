...
public class IterationSolver {
  ...
  private static edu.psu.cse.siis.coal.IterationSolver instance = new edu.psu.cse.siis.coal.IterationSolver();
  ...
  public static edu.psu.cse.siis.coal.IterationSolver v() {
    return instance;
  }
