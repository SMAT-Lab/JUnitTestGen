...
public class ScalarFieldValue extends FieldValue {
  ...
  public boolean equals(Object other) {
    return other instanceof edu.psu.cse.siis.coal.field.values.ScalarFieldValue
        && Objects.equals(this.value, ((edu.psu.cse.siis.coal.field.values.ScalarFieldValue) other).value);
  }
}
