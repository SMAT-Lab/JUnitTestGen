...
public class SetFieldValue extends FieldValue {
  ...
  public boolean equals(Object other) {
    return other instanceof edu.psu.cse.siis.coal.field.values.SetFieldValue
        && Objects.equals(this.values, ((edu.psu.cse.siis.coal.field.values.SetFieldValue) other).values);
  }
