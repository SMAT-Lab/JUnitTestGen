...
public class NullFieldTransformer extends FieldTransformer {
  private static edu.psu.cse.siis.coal.field.transformers.NullFieldTransformer instance = new edu.psu.cse.siis.coal.field.transformers.NullFieldTransformer();

  private NullFieldTransformer() {
  }

  public static edu.psu.cse.siis.coal.field.transformers.NullFieldTransformer v() {
    return instance;
  }
