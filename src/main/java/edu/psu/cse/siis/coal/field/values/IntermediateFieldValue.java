...
public class IntermediateFieldValue extends FieldValue {
  ...
  public boolean equals(Object other) {
    if (!(other instanceof edu.psu.cse.siis.coal.field.values.IntermediateFieldValue)) {
      return false;
    }
    edu.psu.cse.siis.coal.field.values.IntermediateFieldValue secondFieldValue = (edu.psu.cse.siis.coal.field.values.IntermediateFieldValue) other;
