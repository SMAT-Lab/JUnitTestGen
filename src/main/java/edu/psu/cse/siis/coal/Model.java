...
public class Model implements Serializable {
  ...
  private static edu.psu.cse.siis.coal.Model instance;
   ...
   */
  public static edu.psu.cse.siis.coal.Model v() {
    if (instance == null) {
  ...
  public static void loadModelFromDirectory(String modelDir) throws FileNotFoundException,
          ParseException {
    if (instance == null) {
      instance = new edu.psu.cse.siis.coal.Model();
    }
  ...
  public static void loadModelFromCompiledFile(String compiledModelFilePath) throws IOException,
    ...
    if (compiledModelFilePath.startsWith("/res/")) {
      inputStream = edu.psu.cse.siis.coal.Model.class.getResourceAsStream(compiledModelFilePath);
    } else {
      inputStream = new FileInputStream(compiledModelFilePath);
    }

    ObjectInputStream objectInputStream = new ObjectInputStream(inputStream);
    instance = (edu.psu.cse.siis.coal.Model) objectInputStream.readObject();
  }
