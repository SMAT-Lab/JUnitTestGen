 ...
 * transformers.
 */
public class PathTransformer implements Internable<edu.psu.cse.siis.coal.transformers.PathTransformer> {
  private static final Pool<edu.psu.cse.siis.coal.transformers.PathTransformer> POOL = new Pool<>();
   ...
   */
  public edu.psu.cse.siis.coal.transformers.PathTransformer compose(edu.psu.cse.siis.coal.transformers.PathTransformer secondPathTransformer) {
    if (secondPathTransformer instanceof NullPathTransformer) {
      return secondPathTransformer;
    }

    edu.psu.cse.siis.coal.transformers.PathTransformer result = new edu.psu.cse.siis.coal.transformers.PathTransformer();
  ...
  public boolean equals(Object other) {
    return other instanceof edu.psu.cse.siis.coal.transformers.PathTransformer
        && Objects.equals(this.fieldMap, ((edu.psu.cse.siis.coal.transformers.PathTransformer) other).fieldMap);
  }

  @Override
  public edu.psu.cse.siis.coal.transformers.PathTransformer intern() {
