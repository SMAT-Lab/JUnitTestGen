...
public class TopFieldValue extends FieldValue {
  private static final edu.psu.cse.siis.coal.field.values.TopFieldValue instance = new edu.psu.cse.siis.coal.field.values.TopFieldValue();
   ...
   */
  public static edu.psu.cse.siis.coal.field.values.TopFieldValue v() {
    return instance;
  }
