...
public class FieldTransformerManager {
  private static edu.psu.cse.siis.coal.field.transformers.FieldTransformerManager instance = new edu.psu.cse.siis.coal.field.transformers.FieldTransformerManager();
   ...
   */
  public static edu.psu.cse.siis.coal.field.transformers.FieldTransformerManager v() {
    return instance;
  }
