...
public class PropagationValue implements BasePropagationValue, Internable<PropagationValue> {
   ...
   *
   * @param other A {@link edu.psu.cse.siis.coal.values.PropagationValue}.
   * @return The resulting join.
   */
  public BasePropagationValue joinWith(edu.psu.cse.siis.coal.values.PropagationValue other) {
    if (this.pathValues.size() + other.pathValues.size() > Constants.VALUE_LIMIT) {
      return TopPropagationValue.v();
    }

    edu.psu.cse.siis.coal.values.PropagationValue result = new edu.psu.cse.siis.coal.values.PropagationValue();
  ...
  public boolean equals(Object other) {
    return other instanceof edu.psu.cse.siis.coal.values.PropagationValue
        && Objects.equals(this.pathValues, ((edu.psu.cse.siis.coal.values.PropagationValue) other).pathValues);
  }

  @Override
  public edu.psu.cse.siis.coal.values.PropagationValue intern() {
