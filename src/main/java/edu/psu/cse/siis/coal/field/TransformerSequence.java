...
public class TransformerSequence {
  ...
  public TransformerSequence(edu.psu.cse.siis.coal.field.TransformerSequence otherTransformerSequence) {
   ...
   */
  public void addElementsToSequence(edu.psu.cse.siis.coal.field.TransformerSequence transformerSequence) {
  ...
  public boolean equals(Object other) {
    if (!(other instanceof edu.psu.cse.siis.coal.field.TransformerSequence)) {
      return false;
    }
    edu.psu.cse.siis.coal.field.TransformerSequence secondTransformerSequence = (edu.psu.cse.siis.coal.field.TransformerSequence) other;
